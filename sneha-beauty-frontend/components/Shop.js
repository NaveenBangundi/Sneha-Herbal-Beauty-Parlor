        ...
        <div className="relative z-10 w-full">
              ...
              {["TRENDING", "SKIN", "HAIR", "MAKEUP"].map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 md:px-6 py-2 rounded-full text-[10px] md:text-xs font-bold tracking-widest transition-all duration-300 ${isActive
          ...
          <div className="relative flex items-center gap-2 md:gap-4">
            ...
            <button
              ...
              className={`w-10 h-10 shrink-0 rounded-full border border-green-100 flex items-center justify-center bg-white shadow-sm hover:bg-green-50 transition-all ${startIndex === 0 ? "opacity-30 cursor-not-allowed" : "hover:scale-105 hover:shadow-md active:scale-95 text-green-800"
                }`}
            >
            ...
            <button
              ...
              className={`w-10 h-10 shrink-0 rounded-full border border-green-100 flex items-center justify-center bg-white shadow-sm hover:bg-green-50 transition-all ${startIndex + 4 >= filteredProducts.length ? "opacity-30 cursor-not-allowed" : "hover:scale-105 hover:shadow-md active:scale-95 text-green-800"
                }`}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
